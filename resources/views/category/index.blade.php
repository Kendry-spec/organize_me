                    ...
                    @if ($categories->isEmpty())
                        <div class="flex justify-center items-center py-12">
                            <div class="text-center">
                                <h2 class="text-3xl font-bold mb-4">No tasks found</h2>
                                <p class="text-3xl text-gray-700 mb-10">You don't have any task yet. Please add one!</p>
                                <a href="{{ route('category.create') }}" class="text-2xl bg-orange-500 hover:bg-orange-700 text-white py-2 px-4 rounded">Add a task</a>
                            </div>
                        </div>
                    @else
                        <!-- To-Do List Table -->
